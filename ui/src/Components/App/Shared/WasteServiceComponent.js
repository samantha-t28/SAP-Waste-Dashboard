function WasteServiceComponent({ percentage, months, filter }) {
	let result = [];
	...
	oldMonth = result[oldMonthIndex]["wasteTotal"];
	newMonth = result[newMonthIndex]["wasteTotal"];
...
export default WasteServiceComponent;
